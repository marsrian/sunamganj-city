    ...
    <table className="w-full mt-8">
      <thead className="border-b border-stone-200 bg-stone-100 text-sm font-medium text-stone-600">
        <tr>
          ...
          <th className="px-2.5 py-2 text-start font-medium">Blog Ttitle</th>
      ...
      <tbody className="group text-sm text-stone-800">
        {data.map((item) => (
          ...
          >
            ...
            <td className="p-2 dark:text-white">{item.blog_title}</td>
            <td className="p-2">
              <Link href={`/dashboard/blogs/approval_blog/${item._id}`}>
