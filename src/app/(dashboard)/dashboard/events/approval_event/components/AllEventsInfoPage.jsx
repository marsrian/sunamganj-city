      ...
      <tbody className="group text-sm text-stone-800">
        {data.map((item) => (
          ...
          >
            ...
            <td className="p-2 dark:text-white">{item.event_title}</td>
            <td className="p-2">
              <Link href={`/dashboard/events/approval_event/${item._id}`}>
...
export default AllEventsInfoPage
